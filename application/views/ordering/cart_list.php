        ...
        <div class="col-md-8 mb-4">
          ...
          <ul class="list-group mb-3 z-depth-1" id="list-holder">
            ...
            <li class="list-group-item d-flex justify-content-between" id="total-holder" >
              <span>Total (Php)</span>
              <strong id="gTotal">Rp. 0.00</strong>
            </li>
          </ul>
          <!-- Cart -->
            ...
            if(typeof resp != undefined){
                ...
                if(Object.keys(resp).length > 0){
                    ...
                    Object.keys(resp).map(k=>{
                        ...
                        li.find('.price').html('<span>Price: </span>Rp.  '+resp[k].price)
                        ...
                        li.find('.total_amount').html('Rp.  '+tAmount)
                        li.find('[name="tAmount[]"]').val(tAmount)
                        total += parseFloat(tAmount);
                        $('#total-holder').before(li)
                    })
                    if(total > 0)
                    $('#gTotal').html('Rp.  '+(parseFloat(total).toLocaleString('en-US',{ style :'decimal','maximumFractionDigits':2 })))
                }
            }
        },
        complete:()=>{
